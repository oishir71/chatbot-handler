...
class Datasethandler(BaseHandler):
    ...
    def get_dataset(self, dataset_uuid: str) -> dict:
        ...
        response = requests.get(
            "%s/%s/" % (self.base_url, dataset_uuid), auth=self.authorization
        )
        self.parse_response(response=response)
...
if __name__ == "__main__":
    ...
    #     name="roishi-sample-temp", datatype_uuid="494c8b2f-44da-4e0d-8b45-088d51892b32"
    # )
    ...
    pprint.pprint(
        handler.get_dataset(dataset_uuid="75801414-68de-4c8c-a00f-efd93d323cf2")
    )
